...
root = tk.Tk()
root.title("Vecherinsky OSIS BSUIR 2022")
root.geometry("600x600")
root.config(background="#3e2d5e")
root.resizable(0, 0)
apps = []
key = ''
